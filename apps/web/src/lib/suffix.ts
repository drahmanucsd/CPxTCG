...
export const FAMILY_LABEL: Record<string, string> = {
  close: 'Close', inversions: 'Inv', shell: 'Shell', guide: 'LH 3-7', root37: 'RH root + LH 3-7', rootlessA: 'Rootless A', rootlessB: 'Rootless B', rootless3A: '3-note A', rootless3B: '3-note B',
