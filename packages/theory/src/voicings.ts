...
export const FAMILIES: FamilyDef[] = [
  ...
  {
    id: 'root37', name: 'LH root, RH 3-7', short: 'Root + 3-7', hand: 'both', group: 'basic',
    description: 'Left hand plays the root on its own; right hand plays the guide tones (3rd and 7th). The first two-hand setup: the root anchors the key in the bass where it belongs, and the right hand learns the voice leading.',
    templates: {
      maj7: ['1 | 3 7', '1 | 7 3'], maj6: ['1 | 3 6', '1 | 6 3'], min7: ['1 | b3 b7', '1 | b7 b3'],
      min6: ['1 | b3 6', '1 | 6 b3'], minmaj7: ['1 | b3 7', '1 | 7 b3'],
      dom7: ['1 | 3 b7', '1 | b7 3'], dom7sus: ['1 | 4 b7', '1 | b7 4'], alt: ['1 | 3 b7', '1 | b7 3'],
      halfdim: ['1 | b3 b7', '1 | b7 b3'], dim7: ['1 | b3 bb7', '1 | bb7 b3'], aug7: ['1 | 3 b7', '1 | b7 3'],
      maj: ['1 | 3 5'], min: ['1 | b3 5'],
    },
    box: EITHER_BOX, leftBox: BASS_BOX,
    rightBox: { lowestMin: MIDI.C3 + 4, lowestMax: MIDI.C5, top: MIDI.C6 }, maxSpan: 12,
  },
  {
